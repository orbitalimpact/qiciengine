...
qici.loadFinish = false;

// the flag is set to true when a asset loaded
qici.oneAssetLoaded = false;
...
qici.splashState = {
    ...
    create: function() {
        ...
        game.phaser.time.events.add(1, function() { game.state.load(game.state.entry, true); });
    }
};
...
style="opacity:0;background:black;position:absolute;z-index:10000">\
<defs>\
